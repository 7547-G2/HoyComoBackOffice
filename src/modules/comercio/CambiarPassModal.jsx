...
const mapDispatch = (dispatch) => ({
  updateComercio: (idComercio, password, confirmacionPassword) => {
    dispatch(updateComercio(idComercio, null, null, password, confirmacionPassword))
  }
})
