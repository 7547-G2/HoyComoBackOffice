...
export class BuscarUsuarioTable extends React.Component {
  ...
  getTablaUsuarios() {
    if (this.props.activeSearch && this.props.result.length != 0) {
      return <CustomTableWithPaginationAndButtons data={ordenarPorId(this.props.result)} headers={['Usuario','Dirección','Link a Facebook','Teléfono','Estado', 'Motivo de Deshabilitación']}
